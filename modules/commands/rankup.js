...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
	...
	if (level > curLevel && level != 1) {
		...
		if (existsSync(__dirname + `/cache/rankup/rankup.mp4`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup/rankup.mp4`
...
module.exports.languages = {
	"vi": {
		...
		"levelup": "Trình độ chém gió như Yasuo của con vợ {name} đã đạt tới level {level}"
	},
	"en": {
		"on": "on",
		"off": "off",
